...
//	ON_UPDATE_COMMAND_UI(ID_DRAW_ELLIPSE, &CAboutDlg::OnUpdateDrawEllipse)
//	ON_UPDATE_COMMAND_UI(ID_DRAW_LINE, &CAboutDlg::OnUpdateDrawLine)
//	ON_UPDATE_COMMAND_UI(ID_DRAW_PEN, &CAboutDlg::OnUpdateDrawPen)
...
//void CAboutDlg::OnUpdateDrawEllipse(CCmdUI* pCmdUI)
//{
...
//void CAboutDlg::OnUpdateDrawPen(CCmdUI* pCmdUI)
//{
//	// TODO: 在此添加命令更新用户界面处理程序代码
//}
